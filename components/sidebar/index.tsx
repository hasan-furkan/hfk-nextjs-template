                ...
                <div className="h-20 border-b-gray-200 border-b-2 rounded-md mt-2">
                    <div className="flex justify-around items-center">
                        ...
                        <div className="absolute right-[-18px] top-7 cursor-pointer bg-purple-300 rounded-3xl p-1">
                            <Image src="/svgs/sidebarMenu.svg" alt="sidebarRight" width={24} height={24} className="text-l" />
                        </div>
                    </div>
                </div>
                <div className="flex flex-col p-1 overflow-y-auto scroll-smooth">
                   <div className="text-gray-50 mt-2 rounded-3xl gap-2 relative">
                       <div className="flex w-full ml-1 p-1 my-2 bg-purple-300 rounded-3xl items-center">
                           <Image src="/svgs/home.svg" alt="home" width={28} height={28} className="ml-2" />
                           <h1 className="text-2xl font-bold ml-2">Home</h1>
                           <Image src="/svgs/sidebarRight.svg" alt="sidebarRight" width={24} height={24} className="absolute right-1" />
                       </div>
